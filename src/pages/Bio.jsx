      ...
      <div className="bg-inherit  py-[2%] px-[0.8%] absolute top-[30vh] md:top-[50vh]">
        ...
        <div className="py-[2%] px-[2%] bg-black bg-opacity-50 md:w-1/2 text-justify text-purple-400">
          <p className="">
            ...
            and anchoring programs such as 'Sishu Mahal,' 'Chhutir Ghanta,' and
            'Golpo Dadur Ashor.' Additionally, she was involved in reading the
            news.
          </p>
          <p>
            ...
            Bandopadhyay, and Padmabibhushan late Girija Devi. Sritama also got
            the guidance of Srimati Lopamudra Mitra for some years.
          </p>
        </div>
